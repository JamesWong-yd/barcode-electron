<template>
  <div ref="maincontainer" class="barcode-container">
    ...
    <div class="barcode-box-c" :class="{'barcode-box-Active': opacity}">
      <main-qrcode :barcode="code" :scale="scale"></main-qrcode>
    </div>
    <!-- 搜索栏 -->
    <div class="code-input-box" :style="{top: !searchFlag ? 0 : '', transform: !searchFlag? 'translate(-50%, 0)': ''}">
      ...
      <div class="code-input-co">
        <Input v-model="tochangData"
               ...
               placeholder="请输入所需生成的编号,创建多个二维码请回车换行输入..." />
...
export default {
  ...
  methods: {
    ...
    sizeComputed() {
      this.scale = {
        width: 120 * this.baseSize + 'px',
        height: 120 * this.baseSize + 'px'
      }
    },
    handleFocus(e) {
  ...
  components: {
    ...
    mainQrcode: require('@/components/main-qrcode').default
  }
}
</script>
